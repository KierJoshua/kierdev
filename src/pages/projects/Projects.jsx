  ...
  <div className="modal-box bg-slate-900 max-w-5xl p-8 rounded-lg shadow-lg">
    ...
    <div className="space-y-8 text-gray-300 leading-relaxed text-2xl">
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-1/2">
          <p>
            ...
            is a comprehensive web application designed for optical clinics to optimize daily operations. 
            It provides seamless inventory management for eyeglasses, frames, and accessories, while also integrating an automated billing system 
            to track client payments, reducing overdue balances and ensuring smooth financial transactions.
          </p>
          <p className="mt-3">
            As the{" "}
            <span className="text-[#40A2D8] font-semibold">
            ...
            , I was responsible for designing and implementing the user interface (UI), 
            ensuring a responsive, user-friendly experience. I leveraged HTML, CSS, Bootstrap, and JavaScript, 
            while the backend was developed using PHP and MySQL.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
      ...
      <div className="flex flex-col lg:flex-row-reverse gap-6">
        <div className="lg:w-1/2">
          <p>
            The system features multiple user roles for structured workflow management. 
            The{" "}
            <span className="text-[#40A2D8] font-semibold">
              Superadmin (Owner)
            </span>{" "}
            has full control over all branches, while staff members have access permissions based on their assigned clinic. 
            Staff can update inventory but require admin approval for critical changes, ensuring security and accountability.
          </p>
          <p className="mt-3">
            I developed the role-based UI components, ensuring dynamic access controls 
            and a smooth, structured experience for different users.
          </p>
        </div>
        <div className="lg:w-1/2">
        <img
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="lg:w-1/2">
          <p>
            A built-in{" "}
            <span className="text-[#40A2D8] font-semibold">request system</span>{" "}
            allows staff to submit supply requests, which are reviewed and approved by the Superadmin. 
            This structured process prevents unauthorized inventory modifications and ensures smooth coordination across multiple branches.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
      ...
      <div className="flex flex-col lg:flex-row-reverse gap-6">
        <div className="lg:w-1/2">
          <p>
            To enhance operational efficiency, the system includes real-time notifications 
            that alert the Superadmin of inventory updates, staff activities, and pending approvals. 
            These notifications ensure seamless communication between branches and management.
          </p>
        </div>
        <div className="lg:w-1/2">
          <img
