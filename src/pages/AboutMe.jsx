      ...
      <div className="min-h-screen w-full bg-custom-gradient pt-24 sm:pt-32 md:pt-36 flex flex-col items-center px-6 sm:px-12">
        <div className="max-w-4xl w-full text-white text-justify">
          ...
          >
            ...
            applications. I'm currently leveling up my skills to become a{" "}
          ...
          >
            ...
            <span className="font-bold">new challenges</span> that push my
            limits. Writing clean, maintainable code is my priority, and I
            strongly believe in
            <span className="font-bold"> lifelong learning</span> to stay ahead
          ...
          >
            ...
            where I can apply my skills, contribute to exciting projects, and
          ...
          <div className="w-full text-left">
            ...
            <ul
              className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-lg font-medium px-6 sm:px-0"
              data-aos="fade-up"
              data-aos-duration="2700"
            >
              <li>⚡ React.js</li>
